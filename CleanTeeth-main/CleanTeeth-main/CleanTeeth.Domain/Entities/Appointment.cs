...
public class Appointment
{
    ...
    public void ValidateTreatmentDuration(AppointmentType type)
    {

        if (type == AppointmentType.Treatment && TimeInterval.DurationInMinutes < 30)
        {
            throw new BusinessRuleException("Las citas de tratamiento deben durar al menos 30 minutos");
        }
    }
